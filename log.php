        ...
        <div class="main-header" style="background-color: #1269DB;">
            ...
            <div class="container">
                <div class="logo-header" data-background-color="blue2">
                    ...
                    <a href="index.php">
                        <img src="assets/img/smkharapan.png" alt="navbar brand" class="navbar-brand" width="40">
                    ...
                    <div class="container">
                        <div class="page-inner py-5">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                <div>
                                    <h2 class="text-white pb-2 fw-bold">SMK HARAPAN TIMIKA</h2>
                                    <h5 class="text-white op-7 mb-2">Absen Lebih mudah gunakan Aplikasi Absensi</h5>
                                </div>
                                <div class="ml-md-auto py-2 py-md-0">
                                    <a href="#" class="btn btn-white btn-border btn-round mr-2">Kp. Belakang SPBU RT/RW 07/02 Ds. Nawaripi. Kab. Timika 16370 Prov. Papua 
                            <br>Email : smkharapantimika@gmail.com Phone.081234567890
            ...
            <footer class="footer">
                <div class="container">
                    <div class="copyright ml-auto">
                        &copy; <?php echo date('Y');?> SMK Harapan Timika Absensi Siswa<a href="index.php">Melpen Yogi </a> | 2022
                    </div>
                </div>
            </footer>
