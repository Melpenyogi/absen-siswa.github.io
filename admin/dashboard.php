...
<head>
	...
	<title>Administrator Absensi</title>
	<meta content='width=device-width, initial-scale=1.0, shrink-to-fit=no' name='viewport' />
	<link rel="icon" type="image/png" href="../assets/img/smkharapan.png"/>
		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="dashboard.php" class="logo">
					...
					<b class="text-white">SMK HARAPAN</b>
				</a>
		...
		<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y');?> SMK Harapan Timika (<a href="index.php">Oleh : Melpen yogi </a> | 2022)
					</div>				
				</div>
			</footer>
		</div>
