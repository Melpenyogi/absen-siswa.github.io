					...
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								...
								<h5 class="text-white op-7 mb-2">Selamat Datang Sebagai Guru, <b class="text-warning"><?=$data['nama_guru']; ?></b></h5>
							</div>
							...
							<div class="card full-height">
								<div class="card-body">
									<div class="card-title">
										<center>
											<img src="../assets/img/smkharapan.png" width="50">
											<br>
											<b>SMK HARAPAN TIMIKA</b>
										</center>
									</div>
									<div class="card-category">
										<center>
						Belakang SPBU RT/RW 07/02 Desa Nawaripi. Kabupaten. Timika 16370 Provinsi. Papua 
                            <br>Email : smkharapantimika@gmail.com 
                            <br>Phone : 081234567890 
										</center>
									</div>
